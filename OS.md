...
- 소스: 카카오 자체 채용 페이지의 공개 JSON `https://careers.kakao.com/public/api/job-list`(2026-07-15 실측 동작, 마감일 포함 구조화 데이터). `source = "kakao"`. 성격: **회사 공식 페이지 계열 어댑터 1호**(7장 허용 원칙 범위, 플랫폼 크롤링 금지와 무관).
